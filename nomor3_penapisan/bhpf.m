function G2 = bhpf(image, D0)
    ...
    % Penapis yang digunakan adalah Butterworth Highpass Filter (BHPF)
    ...
    % Butterworth Highpass Filter: H = 1 / (1 + (D0/D)^(2n))
    ...
    %figure, imshow(G2); title('Butterworth Highpass Filter Output');
end
